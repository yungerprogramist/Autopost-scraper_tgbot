...
def sakha_press():
    try:
        ...
        return f'Error:21 - Упс, что-то пошло не так на первой стадии на сайте sakha_press - {ex}'
...
def news_page(url):
    try:
        ...
        return f'Error:22 - Упс, что-то пошло не так на второй стадии на сайте sakha_press - {ex}'
